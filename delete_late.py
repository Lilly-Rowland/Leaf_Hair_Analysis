...
def main(image_dir, tile_dir, model, loss, results_path):
    ...
    for leaf in os.listdir(image_dir):
        ...
        # unique_values, counts = np.unique(reconstructed_mask, return_counts=True)
        ...
        # unique_values, counts = np.unique(landing_area_mask, return_counts=True)
        # print("Unique Values:", unique_values)
        # print("Counts:", counts)
...
if __name__ == "__main__":
    ...
    results = "labelbox_hair_model_results.xlsx"
