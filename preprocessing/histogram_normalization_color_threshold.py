...
output_folder = 'leaf_samples/normalized_images/changing_thresholds/threshold_0_255'
threshold_low = 0   # Lower threshold for normalization
threshold_high = 255 # Upper threshold for normalization
